...
export function LetsWorkTogether() {
    ...
    const handleBookCall = () => {
        window.open("https://a10empreendimentos.com/", "_blank")
    }
        ...
        <section className="flex min-h-screen items-center justify-center px-6">
            <div className="relative flex flex-col items-center gap-12">
                ...
                >
                    ...
                    {/* Subtle subtext */}
                    <span
                        className="text-[10px] tracking-widest uppercase text-muted-foreground/50 transition-all duration-500"
                        style={{
                            transform: showSuccess ? "translateY(0)" : "translateY(10px)",
                            opacity: showSuccess ? 1 : 0,
                    ...
                    >
                        Você será redirecionado ao site
                    </span>
                </div>
                    ...
                    <div className="flex flex-col items-center gap-6">
                        ...
                        >
                            ...
                            <span className="block overflow-hidden">
                                ...
                                >
                                    <span className="text-muted-foreground/60">Empreendimentos</span>
                                </span>
                            </span>
                        </h2>
                ...
                >
                    <p className="max-w-md text-sm leading-relaxed text-muted-foreground">
                        A materialização da nossa visão. Explore os empreendimentos que levam a marca A10.
                    </p>
                    <span className="text-xs tracking-widest uppercase text-muted-foreground/60">a10empreendimentos.com.br</span>
                </div>
            </div>
        </section>
    )
